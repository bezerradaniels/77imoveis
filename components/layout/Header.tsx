    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-black/5" style={{ backgroundImage: 'var(--header-grad)' }}>
      <div className="mx-auto flex max-w-[1200px] items-center justify-between gap-4 px-6 py-4">
        ...
        <nav className="flex items-center gap-3 sm:gap-4">
          <Link
            href="/anunciar"
            className="hidden min-h-11 items-center rounded-[10px] bg-primary px-3 py-2 text-sm font-bold text-on-primary shadow-[0_10px_22px_-14px_rgba(14,165,233,.45)] transition-colors hover:bg-primary-hover md:inline-flex"
          >
            Anunciar imóvel
          </Link>
          <AuthNav />

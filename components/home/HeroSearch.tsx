  ...
  return (
    <>
      ...
      <button
        ...
        className="flex h-11 w-full max-w-[260px] items-center justify-center gap-2 rounded-xl border border-primary px-4 text-[15px] font-bold text-white transition-colors hover:bg-primary/10 md:hidden"
      >

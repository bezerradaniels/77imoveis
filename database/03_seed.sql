...
insert into cities (name, slug, state, ddd, latitude, longitude, is_featured, population, seo_title, seo_description, intro_text) values
  ('Vitória da Conquista','vitoria-da-conquista','BA',77,-14.8615,-40.8442,true,374000,
   ...
   'Casas, apartamentos e terrenos à venda e para alugar em Vitória da Conquista. Anúncios de imobiliárias e corretores da região do DDD 77.',
  ...
  ('Guanambi','guanambi','BA',77,-14.2231,-42.7806,true,88000,
   ...
   'Anúncios de casas, apartamentos e terrenos em Guanambi, no sudoeste da Bahia. Compre, venda ou alugue na região do DDD 77.',
  ...
  ('Brumado','brumado','BA',77,-14.2036,-41.6653,true,70000,
   ...
   'Casas, apartamentos e terrenos à venda e para alugar em Brumado, na Bahia. Anúncios da região do DDD 77.',

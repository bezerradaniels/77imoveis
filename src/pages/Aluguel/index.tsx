      ...
      <Container className="py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3 text-sm text-gray-500">
            ...
            <span className="text-blue-600 font-medium">Aluguel</span>
          </div>
          <button
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-sm text-gray-500">
                {loading ? "Carregando..." : `${items.length} imóveis para aluguel`}
              </p>
            ...
            {loading ? (
              ...
              <div className="rounded-2xl bg-white border border-gray-200 p-12 text-center shadow-sm">
                ...
                <div className="font-semibold text-gray-900 text-lg">Nenhum imóvel para aluguel</div>

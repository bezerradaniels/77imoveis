      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3 rounded-xl border border-dashed border-lime-200 bg-lime-50/60 px-4 py-5 text-sm leading-relaxed text-lime-900">
          ...
          <div className="flex flex-col gap-2 text-sm font-medium">
            <Link to={paths.registerUsuario} className="text-lime-700 hover:text-lime-900">
              Sou comprador/investidor
            </Link>
            <Link to={paths.registerCorretor} className="text-lime-700 hover:text-lime-900">
              Sou corretor parceiro
            </Link>
            <Link to={paths.registerImobiliaria} className="text-lime-700 hover:text-lime-900">
              Sou imobiliária
            </Link>
          </div>
        </div>

      ...
      <Container className="py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3 text-sm text-gray-500">
            ...
            <span className="text-orange-600 font-medium">Vendas</span>
          </div>
          <button
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-6">
              <p className="text-sm text-gray-500">
                {loading ? "Carregando..." : `${items.length} imóveis à venda`}
              </p>
            ...
            {loading ? (
              <div className="py-20 text-center">
                <div className="inline-block w-10 h-10 border-3 border-orange-500 border-t-transparent rounded-full animate-spin" />
              ...
              <div className="rounded-2xl bg-white border border-gray-200 p-12 text-center shadow-sm">
                ...
                <div className="font-semibold text-gray-900 text-lg">Nenhum imóvel à venda</div>
